...
flirt -in $2  -ref $elecReconPath/T1.nii -out $elecReconPath/mri2CT.nii -omat $elecReconPath/mri2CT.mat -interp trilinear -cost mutualinfo -dof 12 -searchcost mutualinfo -searchrx -180 180 -searchry -180 180 -searchrz -180 180

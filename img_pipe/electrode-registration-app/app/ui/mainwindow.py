...
"}")
        ...
        self.label_11 = QtGui.QLabel(self.frame_segment)
        font = QtGui.QFont()
        ...
        self.gridLayout_2.addWidget(self.horizontalSlider_threshold, 0, 0, 1, 1)
        self.spinBox_threshold = QtGui.QSpinBox(self.groupBox)
        self.spinBox_threshold.setObjectName("spinBox_threshold")
        self.gridLayout_2.addWidget(self.spinBox_threshold, 0, 1, 1, 1)
        self.verticalLayout.addWidget(self.groupBox)
        self.groupBox_2 = QtGui.QGroupBox(self.frame_segment)
        ...
        self.label_12 = QtGui.QLabel(self.frame_segment_config)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setWeight(75)
        font.setBold(True)
        ...
        self.pushButton_electrodeNumbering = QtGui.QPushButton(self.tab_label)
        self.pushButton_electrodeNumbering.setCheckable(False)
        self.pushButton_electrodeNumbering.setObjectName("pushButton_electrodeNumbering")
        self.verticalLayout_5.addWidget(self.pushButton_electrodeNumbering)
        ...
        self.gridLayout_4 = QtGui.QGridLayout(self.tab_register)
        ...
        self.gridLayout_4.addWidget(self.listView_register, 0, 0, 1, 1)
        ...
        self.line_2 = QtGui.QFrame(self.tab_register)
        ...
        self.horizontalLayout_2.addWidget(self.pushButton_register_clear)
        ...
        self.horizontalLayout_2.addWidget(self.pushButton_unregister)
        self.gridLayout_4.addLayout(self.horizontalLayout_2, 5, 0, 1, 1)
        self.gridLayout = QtGui.QGridLayout()
        self.gridLayout.setObjectName("gridLayout")
        self.spinbox_Diameter = QtGui.QSpinBox(self.tab_register)
        self.spinbox_Diameter.setMinimum(1)
        self.spinbox_Diameter.setMaximum(40)
        self.spinbox_Diameter.setProperty("value", 20)
        self.spinbox_Diameter.setObjectName("spinbox_Diameter")
        self.gridLayout.addWidget(self.spinbox_Diameter, 0, 3, 1, 1)
        self.label_14 = QtGui.QLabel(self.tab_register)
        self.label_14.setMinimumSize(QtCore.QSize(100, 27))
        ...
        font.setWeight(75)
        font.setBold(True)
        self.pushButton_AvgSurfNormal.setFont(font)
        ...
        self.horizontalLayout_13.addWidget(self.pushButton_nearest)
        self.pushButton_export = QtGui.QPushButton(self.tab_register)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(QtGui.QApplication.translate("MainWindow", "CT Image", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pushButton_electrodeNumbering.setText(QtGui.QApplication.translate("MainWindow", "Start Electrode Numbering", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.spinbox_Diameter.setToolTip(QtGui.QApplication.translate("MainWindow", "Diameter of the normals being averaged around the electrode. ", None, QtGui.QApplication.UnicodeUTF8))
        self.label_14.setText(QtGui.QApplication.translate("MainWindow", "Diameter", None, QtGui.QApplication.UnicodeUTF8))

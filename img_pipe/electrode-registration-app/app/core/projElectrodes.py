...
# elecmatrix = [50.5860137, 48.381790, 9.12573242]
# direction = [-0.64649912, -0.3702360, 0.1845822]

# to_position = 43.24366,44.17698, 11.222

def projectElectrodes(tri, vert, elecmatrix, direction):
    '''
    ...
    sulci.
     ...
     Inputs: cortex:       cortical surface struct (with fields cortex.vert
             ...
             proj_direction:    a string with value
                           ...
                           the projection direction per electrode as calculate
    ...
    elec_proj = np.zeros(elecmatrix.shape)
...
#     elecmatrix = np.array([50.5860137, 48.381790, 9.12573242])
#     direction = np.array([-0.64649912, -0.3702360, 0.1845822])
#     cortex = scipy.io.loadmat('/home/michael/Documents/Subjects/DY_043_AL/Meshes/rh_dural_trivert.mat')
#     tri, vert = cortex['tri'], cortex['vert']
#     projected = projectElectrodes(tri,vert,elecmatrix,direction)
#     print projected
#     print '43.24366,44.17698, 11.222'
